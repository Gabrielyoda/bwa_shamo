...
Color secoundaryColor = Color(0xff38ABBE);
...
Color secoundaryTextColor = Color(0xff999999);
Color subtitleColor = Color(0xff504F5E);

TextStyle primaryTextStyle = GoogleFonts.poppins(color: primaryTextColor);

TextStyle secoundaryTextStyle = GoogleFonts.poppins(color: secoundaryColor);

TextStyle priceTextStyle = GoogleFonts.poppins(color: priceColor);

TextStyle subtitleStyle = GoogleFonts.poppins(color: subtitleColor);
